---
title: BarChart
description: Vertical or horizontal bar chart, single, stacked or grouped, for comparing values across categories. Zero dependencies — built with SVG and own math utilities. Keyboard navigable, with a data table disclosure.
---
